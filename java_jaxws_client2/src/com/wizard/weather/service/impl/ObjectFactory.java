 ...
 * generated in the com.wizard.weather.service.impl package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetWeatherInfo_QNAME = new QName("http://impl.service.weather.wizard.com/", "getWeatherInfo");
    private final static QName _GetWeatherInfoResponse_QNAME = new QName("http://impl.service.weather.wizard.com/", "getWeatherInfoResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.wizard.weather.service.impl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.weather.wizard.com/", name = "getWeatherInfo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.weather.wizard.com/", name = "getWeatherInfoResponse")
