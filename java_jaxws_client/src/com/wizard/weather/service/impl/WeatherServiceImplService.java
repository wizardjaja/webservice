 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://impl.service.weather.wizard.com/", wsdlLocation = "http://192.168.2.128:8888/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.weather.wizard.com/", "WeatherServiceImplService");
    ...
    public WeatherServiceImpl getWeatherServiceImplPort() {
        return super.getPort(new QName("http://impl.service.weather.wizard.com/", "WeatherServiceImplPort"), WeatherServiceImpl.class);
    }
    ...
    public WeatherServiceImpl getWeatherServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.weather.wizard.com/", "WeatherServiceImplPort"), WeatherServiceImpl.class, features);
    }
